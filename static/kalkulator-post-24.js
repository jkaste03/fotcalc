...
const input_summer = [
    ...
    [UCL_sisteplass,UCL_sisteplass],
    [UEL_sisteplass,UEL_sisteplass],
    [UECL_sisteplass,UECL_sisteplass],
    [UCL_spilt_utslagsrunde_PO_2122,UCL_spilt_utslagsrunde_PO_2122],
	...
	[UCL_value_pillar,UCL_value_pillar],
    [UEL_value_pillar,UEL_value_pillar],
    [UECL_value_pillar,UECL_value_pillar],
];
